    ...
    return(
        ...
        <div className="container itemDetailRow">
            <div id="carouselExampleIndicators" className="carousel slide mx-auto itemDetailcol1" data-bs-ride="carousel">
                {product!==[]?<IndicatorCarousel imgs={product.arrayImgCarousel} key={product.id+"IndicatorCarousel"}/>: <div></div> }
                {product!==[]?<ImgCarousel imgs = {product.arrayImgCarousel} key={product.id+"imgCarousel"}/>: <div></div> }
